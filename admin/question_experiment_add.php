        ...
        <?php
            ...
            if (isset($_POST['save'])) {
                if ($_POST['des'] != "") {                                        
                    ...
                    $ins = "INSERT INTO question_experiment (experiment_id, des, op1, op2, op3, op4, ans, status) 
                            VALUES ('$experiment_id', '$des', '$op1', '$op2', '$op3', '$op4', '$ans', '1');";    
            ...
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <h5>
                                ...
                                <?php 
                                    include 'db.php';
                                    $query = mysqli_query($link, "select * from experiment where id = '$_GET[id]'");
                ...
                <div class="row">
                    ...
                    <div>
                        <?php
                        $sl=0; 
                        $query = mysqli_query($link, "select * from question_experiment where experiment_id = '$_GET[id]'");
                        while($data = mysqli_fetch_array($query)) {
                            echo ++$sl.". ";
                            echo $data['des'];
                            echo "<br>";
